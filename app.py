...
model1 = load_model(r"D:\download\DBMS\models\model1.h5")  # Replace with actual paths
model2 = load_model(r"D:\download\DBMS\models\model2.h5")  # Replace with actual paths

# Load the tokenizer from the file
with open(r'D:\download\DBMS\models\tokenizer.pkl', 'rb') as file:
